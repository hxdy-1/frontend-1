...
const deleteActionPasswordEl = document.getElementById('delete_action--password');

const switchActionNameEl = document.getElementById('switch_action--name');
const switchActionPasswordEl = document.getElementById('switch_action--password');
